## GET http://localhost:37083/health?i=1108 → 200 OK

### Timing
Request started: 2026-09-05T18:49:42.060Z
...
host: localhost:37083
referer: http://localhost:37083/health
...
date: Sat, 05 Sep 2026 18:49:43 GMT
```
...
### cURL
```bash
curl 'http://localhost:37083/health?i=1108' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:37083' \
  -H 'referer: http://localhost:37083/health' \
