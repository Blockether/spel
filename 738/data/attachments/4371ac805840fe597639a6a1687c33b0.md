## GET http://localhost:40825/health?i=325 → 200 OK

### Timing
Request started: 2026-09-05T18:49:11.241Z
...
host: localhost:40825
referer: http://localhost:40825/health
...
date: Sat, 05 Sep 2026 18:49:11 GMT
```
...
### cURL
```bash
curl 'http://localhost:40825/health?i=325' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:40825' \
  -H 'referer: http://localhost:40825/health' \
