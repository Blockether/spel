## GET http://localhost:35703/health?i=179 → 200 OK

### Timing
Request started: 2026-08-27T17:11:53.225Z
...
host: localhost:35703
referer: http://localhost:35703/health
...
date: Thu, 27 Aug 2026 17:11:53 GMT
```
...
### cURL
```bash
curl 'http://localhost:35703/health?i=179' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:35703' \
  -H 'referer: http://localhost:35703/health' \
