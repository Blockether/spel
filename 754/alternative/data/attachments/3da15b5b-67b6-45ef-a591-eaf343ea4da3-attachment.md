## GET http://localhost:39833/health?i=1079 → 200 OK

### Timing
Request started: 2026-09-15T12:14:52.307Z
...
host: localhost:39833
referer: http://localhost:39833/health
...
date: Tue, 15 Sep 2026 12:14:53 GMT
```
...
### cURL
```bash
curl 'http://localhost:39833/health?i=1079' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:39833' \
  -H 'referer: http://localhost:39833/health' \
