## GET http://localhost:44679/health?i=123 → 200 OK

### Timing
Request started: 2026-09-15T12:14:21.247Z
...
host: localhost:44679
referer: http://localhost:44679/health
...
date: Tue, 15 Sep 2026 12:14:21 GMT
```
...
### cURL
```bash
curl 'http://localhost:44679/health?i=123' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:44679' \
  -H 'referer: http://localhost:44679/health' \
