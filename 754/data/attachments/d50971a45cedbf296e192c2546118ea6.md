## GET http://localhost:36167/set-cookie?name=session&value=abc123 → 404 Not Found

### Timing
Request started: 2026-09-15T12:11:53.233Z
...
date: Tue, 15 Sep 2026 12:11:53 GMT
```
...
### cURL
```bash
curl 'http://localhost:36167/set-cookie?name=session&value=abc123' \
  -H 'accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:36167' \
