## GET http://localhost:43431/health?i=252 → 200 OK

### Timing
Request started: 2026-09-11T10:21:47.658Z
...
host: localhost:43431
referer: http://localhost:43431/health
...
date: Fri, 11 Sep 2026 10:21:47 GMT
```
...
### cURL
```bash
curl 'http://localhost:43431/health?i=252' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:43431' \
  -H 'referer: http://localhost:43431/health' \
