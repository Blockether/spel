## GET http://localhost:39613/health?i=1173 → 200 OK

### Timing
Request started: 2026-09-11T10:22:15.720Z
...
referer: http://localhost:39613/health
...
date: Fri, 11 Sep 2026 10:22:16 GMT
```
...
### cURL
```bash
curl 'http://localhost:39613/health?i=1173' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:39613' \
  -H 'referer: http://localhost:39613/health' \
