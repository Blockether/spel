## POST http://127.0.0.1:36371/spel/hello → 200 OK

### Timing
Request started: 2026-08-20T12:41:09.599Z
...
### cURL
```bash
curl 'http://127.0.0.1:36371/spel/hello' \
  -X POST \
  -H 'accept: */*' \
