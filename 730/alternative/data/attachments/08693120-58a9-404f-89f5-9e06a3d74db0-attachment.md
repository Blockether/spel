## POST http://127.0.0.1:33685/spel/result?t=tkn → 200 OK

### Timing
Request started: 2026-08-20T12:41:11.286Z
...
```json
{
  ...
  "ok": true,
  "value": "pong",
  "id": "3f4060ef-26b2-4112-977a-adc1401f6d1e"
}
```
...
### cURL
```bash
curl 'http://127.0.0.1:33685/spel/result?t=tkn' \
  -X POST \
  -H 'accept: */*' \
