## GET http://127.0.0.1:38619/ → 200 OK

### Timing
Request started: 2026-08-20T12:41:12.165Z
...
<script>
  window.__spel.connect({ url: window.location.origin + "\/spel", token: "rld" });
</script>
</body></html>
