## GET http://localhost:42875/health → 200 OK

### Timing
Request started: 2026-08-20T12:41:36.028Z
...
date: Thu, 20 Aug 2026 12:41:36 GMT
```
...
### cURL
```bash
curl 'http://localhost:42875/health' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:42875' \
  -H 'referer: http://localhost:42875/' \
