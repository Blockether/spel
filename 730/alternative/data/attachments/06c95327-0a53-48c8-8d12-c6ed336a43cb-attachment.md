## POST http://127.0.0.1:33459/spel/hello?t=nosw → 200 OK

### Timing
Request started: 2026-08-20T12:41:13.232Z
...
host: 127.0.0.1:33459
origin: http://127.0.0.1:33459
referer: http://127.0.0.1:33459/
...
content-length: 11
content-type: application/json
date: Thu, 20 Aug 2026 12:41:13 GMT
```
...
### cURL
```bash
curl 'http://127.0.0.1:33459/spel/hello?t=nosw' \
  -X POST \
  -H 'accept: */*' \
  ...
  -H 'host: 127.0.0.1:33459' \
  -H 'origin: http://127.0.0.1:33459' \
  -H 'referer: http://127.0.0.1:33459/' \
