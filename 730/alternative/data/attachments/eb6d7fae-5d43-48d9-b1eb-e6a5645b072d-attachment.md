## GET http://localhost:44237/nope-404 → 404 Not Found

### Timing
Request started: 2026-08-20T12:41:26.445Z
...
host: localhost:44237
referer: http://localhost:44237/
...
date: Thu, 20 Aug 2026 12:41:26 GMT
```
...
### cURL
```bash
curl 'http://localhost:44237/nope-404' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:44237' \
  -H 'referer: http://localhost:44237/' \
