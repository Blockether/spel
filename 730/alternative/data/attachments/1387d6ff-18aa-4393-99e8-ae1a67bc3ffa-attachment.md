## POST http://127.0.0.1:35397/spel/hello?t=dlg → 200 OK

### Timing
Request started: 2026-08-20T12:41:12.440Z
...
### cURL
```bash
curl 'http://127.0.0.1:35397/spel/hello?t=dlg' \
  -X POST \
  -H 'accept: */*' \
