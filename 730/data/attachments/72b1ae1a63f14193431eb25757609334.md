## POST http://127.0.0.1:37797/spel/hello?t=s3cr3t → 200 OK

### Timing
Request started: 2026-08-20T12:41:10.380Z
...
### cURL
```bash
curl 'http://127.0.0.1:37797/spel/hello?t=s3cr3t' \
  -X POST \
  -H 'accept: */*' \
