## POST http://127.0.0.1:33685/spel/hello?t=tkn → 200 OK

### Timing
Request started: 2026-08-20T12:41:11.191Z
...
host: 127.0.0.1:33685
origin: http://127.0.0.1:33685
referer: http://127.0.0.1:33685/
...
content-length: 11
content-type: application/json
date: Thu, 20 Aug 2026 12:41:11 GMT
```
...
### cURL
```bash
curl 'http://127.0.0.1:33685/spel/hello?t=tkn' \
  -X POST \
  -H 'accept: */*' \
  ...
  -H 'host: 127.0.0.1:33685' \
  -H 'origin: http://127.0.0.1:33685' \
  -H 'referer: http://127.0.0.1:33685/' \
