## POST http://127.0.0.1:32883/spel/hello → 200 OK

### Timing
Request started: 2026-08-21T03:02:43.521Z
...
host: 127.0.0.1:32883
origin: http://127.0.0.1:32883
referer: http://127.0.0.1:32883/
...
content-length: 11
content-type: application/json
date: Fri, 21 Aug 2026 03:02:43 GMT
```
...
### cURL
```bash
curl 'http://127.0.0.1:32883/spel/hello' \
  -X POST \
  -H 'accept: */*' \
  ...
  -H 'host: 127.0.0.1:32883' \
  -H 'origin: http://127.0.0.1:32883' \
  -H 'referer: http://127.0.0.1:32883/' \
