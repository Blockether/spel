## GET http://127.0.0.1:42761/ → 200 OK

### Timing
Request started: 2026-08-21T03:02:45.224Z
...
<script>
  window.__spel.connect({ url: window.location.origin + "\/spel", token: "tkn" });
</script>
</body></html>
