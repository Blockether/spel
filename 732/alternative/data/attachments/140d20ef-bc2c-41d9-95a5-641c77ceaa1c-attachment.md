## POST http://127.0.0.1:42761/spel/hello?t=tkn → 200 OK

### Timing
Request started: 2026-08-21T03:02:45.346Z
...
### cURL
```bash
curl 'http://127.0.0.1:42761/spel/hello?t=tkn' \
  -X POST \
  -H 'accept: */*' \
