## POST http://127.0.0.1:41849/spel/result → 200 OK

### Timing
Request started: 2026-08-21T03:02:44.110Z
...
host: 127.0.0.1:41849
origin: http://127.0.0.1:41849
referer: http://127.0.0.1:41849/
...
```json
{
  ...
  "id": "b697b50f-9988-4c78-80af-aaaef297cbbb"
}
```
...
content-length: 11
content-type: application/json
date: Fri, 21 Aug 2026 03:02:44 GMT
```
...
### cURL
```bash
curl 'http://127.0.0.1:41849/spel/result' \
  -X POST \
  -H 'accept: */*' \
  ...
  -H 'host: 127.0.0.1:41849' \
  -H 'origin: http://127.0.0.1:41849' \
  -H 'referer: http://127.0.0.1:41849/' \
