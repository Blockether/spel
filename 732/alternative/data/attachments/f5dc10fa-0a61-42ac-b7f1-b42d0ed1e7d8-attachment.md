## POST http://127.0.0.1:39129/spel/result?t=s3cr3t → 200 OK

### Timing
Request started: 2026-08-21T03:02:44.703Z
...
origin: http://127.0.0.1:39129
referer: http://127.0.0.1:39129/
...
```json
{
  ...
  "ok": true,
  "value": "pong",
  "id": "20e2d21b-9e57-47dc-8e95-ce447ee79081"
}
```
...
### cURL
```bash
curl 'http://127.0.0.1:39129/spel/result?t=s3cr3t' \
  -X POST \
  -H 'accept: */*' \
  ...
  -H 'host: 127.0.0.1:39129' \
  -H 'origin: http://127.0.0.1:39129' \
  -H 'referer: http://127.0.0.1:39129/' \
