## GET http://localhost:38085/health → 200 OK

### Timing
Request started: 2026-08-21T03:03:05.666Z
...
### cURL
```bash
curl 'http://localhost:38085/health' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:38085' \
  -H 'referer: http://localhost:38085/' \
