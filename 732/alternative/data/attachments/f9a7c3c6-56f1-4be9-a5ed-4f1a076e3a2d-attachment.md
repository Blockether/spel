## GET http://localhost:44651/health?i=1140 → 200 OK

### Timing
Request started: 2026-08-21T03:05:06.482Z
...
host: localhost:44651
referer: http://localhost:44651/health
...
date: Fri, 21 Aug 2026 03:05:07 GMT
```
...
### cURL
```bash
curl 'http://localhost:44651/health?i=1140' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:44651' \
  -H 'referer: http://localhost:44651/health' \
