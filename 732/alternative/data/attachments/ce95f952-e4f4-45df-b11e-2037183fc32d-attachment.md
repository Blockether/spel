## POST http://127.0.0.1:41089/spel/hello?t=dlg → 200 OK

### Timing
Request started: 2026-08-21T03:02:46.243Z
...
### cURL
```bash
curl 'http://127.0.0.1:41089/spel/hello?t=dlg' \
  -X POST \
  -H 'accept: */*' \
