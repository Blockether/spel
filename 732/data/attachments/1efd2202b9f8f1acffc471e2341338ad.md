## POST http://127.0.0.1:41849/spel/hello → 200 OK

### Timing
Request started: 2026-08-21T03:02:44.069Z
...
### cURL
```bash
curl 'http://127.0.0.1:41849/spel/hello' \
  -X POST \
  -H 'accept: */*' \
