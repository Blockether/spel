## POST http://127.0.0.1:34739/spel/result → 200 OK

### Timing
Request started: 2026-08-21T03:02:43.389Z
...
```json
{
  ...
  "ok": true,
  "value": true,
  "id": "7563263e-06ab-4fb2-80fb-4e956cd46b3a"
}
```
...
### cURL
```bash
curl 'http://127.0.0.1:34739/spel/result' \
  -X POST \
  -H 'accept: */*' \
