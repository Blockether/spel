## POST http://127.0.0.1:39129/spel/hello?t=s3cr3t → 200 OK

### Timing
Request started: 2026-08-21T03:02:44.659Z
...
### cURL
```bash
curl 'http://127.0.0.1:39129/spel/hello?t=s3cr3t' \
  -X POST \
  -H 'accept: */*' \
