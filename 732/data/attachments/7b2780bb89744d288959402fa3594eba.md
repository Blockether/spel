## GET http://localhost:46025/health → 200 OK

### Timing
Request started: 2026-08-21T03:03:04.471Z
...
host: localhost:46025
referer: http://localhost:46025/
...
date: Fri, 21 Aug 2026 03:03:04 GMT
```
...
### cURL
```bash
curl 'http://localhost:46025/health' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:46025' \
  -H 'referer: http://localhost:46025/' \
