## GET http://localhost:43965/health?i=1120 → 200 OK

### Timing
Request started: 2026-09-11T03:39:15.988Z
...
referer: http://localhost:43965/health
...
date: Fri, 11 Sep 2026 03:39:17 GMT
```
...
### cURL
```bash
curl 'http://localhost:43965/health?i=1120' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:43965' \
  -H 'referer: http://localhost:43965/health' \
