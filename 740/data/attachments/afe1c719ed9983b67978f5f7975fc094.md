## GET http://localhost:33529/health?i=200 → 200 OK

### Timing
Request started: 2026-09-11T03:38:43.539Z
...
host: localhost:33529
referer: http://localhost:33529/health
...
date: Fri, 11 Sep 2026 03:38:43 GMT
```
...
### cURL
```bash
curl 'http://localhost:33529/health?i=200' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:33529' \
  -H 'referer: http://localhost:33529/health' \
