## GET http://localhost:33835/health?i=339 → 200 OK

### Timing
Request started: 2026-09-14T12:43:41.593Z
...
host: localhost:33835
referer: http://localhost:33835/health
...
date: Mon, 14 Sep 2026 12:43:41 GMT
```
...
### cURL
```bash
curl 'http://localhost:33835/health?i=339' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:33835' \
  -H 'referer: http://localhost:33835/health' \
