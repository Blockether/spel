## GET http://localhost:33729/health?i=1077 → 200 OK

### Timing
Request started: 2026-09-14T12:44:14.476Z
...
host: localhost:33729
referer: http://localhost:33729/health
...
date: Mon, 14 Sep 2026 12:44:15 GMT
```
...
### cURL
```bash
curl 'http://localhost:33729/health?i=1077' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:33729' \
  -H 'referer: http://localhost:33729/health' \
