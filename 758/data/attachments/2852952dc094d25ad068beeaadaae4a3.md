## GET http://localhost:40461/health?i=295 → 200 OK

### Timing
Request started: 2026-09-21T01:54:36.723Z
...
host: localhost:40461
referer: http://localhost:40461/health
...
date: Mon, 21 Sep 2026 01:54:37 GMT
```
...
### cURL
```bash
curl 'http://localhost:40461/health?i=295' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:40461' \
  -H 'referer: http://localhost:40461/health' \
