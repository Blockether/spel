## GET http://localhost:39603/health?i=1059 → 200 OK

### Timing
Request started: 2026-09-21T01:55:08.751Z
...
host: localhost:39603
referer: http://localhost:39603/health
...
date: Mon, 21 Sep 2026 01:55:09 GMT
```
...
### cURL
```bash
curl 'http://localhost:39603/health?i=1059' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:39603' \
  -H 'referer: http://localhost:39603/health' \
