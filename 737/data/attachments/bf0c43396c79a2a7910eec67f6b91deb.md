## GET http://localhost:41447/health?i=224 → 200 OK

### Timing
Request started: 2026-09-05T06:16:19.492Z
...
host: localhost:41447
referer: http://localhost:41447/health
...
date: Sat, 05 Sep 2026 06:16:19 GMT
```
...
### cURL
```bash
curl 'http://localhost:41447/health?i=224' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:41447' \
  -H 'referer: http://localhost:41447/health' \
