## GET http://localhost:36371/set-cookie?name=session&value=abc123 → 404 Not Found

### Timing
Request started: 2026-08-27T14:35:04.430Z
...
date: Thu, 27 Aug 2026 14:35:04 GMT
```
...
### cURL
```bash
curl 'http://localhost:36371/set-cookie?name=session&value=abc123' \
  -H 'accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:36371' \
