## GET http://localhost:37469/health?i=368 → 200 OK

### Timing
Request started: 2026-08-27T14:37:22.541Z
...
host: localhost:37469
referer: http://localhost:37469/health
...
date: Thu, 27 Aug 2026 14:37:22 GMT
```
...
### cURL
```bash
curl 'http://localhost:37469/health?i=368' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:37469' \
  -H 'referer: http://localhost:37469/health' \
