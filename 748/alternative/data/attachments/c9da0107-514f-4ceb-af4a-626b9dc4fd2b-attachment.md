## GET http://localhost:40223/health?i=1056 → 200 OK

### Timing
Request started: 2026-09-11T18:20:07.942Z
...
host: localhost:40223
referer: http://localhost:40223/health
...
date: Fri, 11 Sep 2026 18:20:09 GMT
```
...
### cURL
```bash
curl 'http://localhost:40223/health?i=1056' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:40223' \
  -H 'referer: http://localhost:40223/health' \
