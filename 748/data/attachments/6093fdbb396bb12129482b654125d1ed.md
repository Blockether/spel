## GET http://localhost:44091/health?i=247 → 200 OK

### Timing
Request started: 2026-09-11T18:19:35.395Z
...
host: localhost:44091
referer: http://localhost:44091/health
...
date: Fri, 11 Sep 2026 18:19:35 GMT
```
...
### cURL
```bash
curl 'http://localhost:44091/health?i=247' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:44091' \
  -H 'referer: http://localhost:44091/health' \
