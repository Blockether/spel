## GET http://localhost:39701/set-cookie?name=session&value=abc123 → 404 Not Found

### Timing
Request started: 2026-09-11T15:01:34.805Z
...
date: Fri, 11 Sep 2026 15:01:34 GMT
```
...
### cURL
```bash
curl 'http://localhost:39701/set-cookie?name=session&value=abc123' \
  -H 'accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:39701' \
