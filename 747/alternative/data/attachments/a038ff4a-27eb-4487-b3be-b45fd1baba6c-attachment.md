## GET http://localhost:45389/health?i=159 → 200 OK

### Timing
Request started: 2026-09-11T15:03:50.335Z
...
host: localhost:45389
referer: http://localhost:45389/health
...
date: Fri, 11 Sep 2026 15:03:50 GMT
```
...
### cURL
```bash
curl 'http://localhost:45389/health?i=159' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:45389' \
  -H 'referer: http://localhost:45389/health' \
