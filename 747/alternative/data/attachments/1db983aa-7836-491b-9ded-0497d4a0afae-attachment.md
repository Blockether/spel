## GET http://localhost:33969/health?i=1143 → 200 OK

### Timing
Request started: 2026-09-11T15:04:21.199Z
...
host: localhost:33969
referer: http://localhost:33969/health
...
date: Fri, 11 Sep 2026 15:04:22 GMT
```
...
### cURL
```bash
curl 'http://localhost:33969/health?i=1143' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:33969' \
  -H 'referer: http://localhost:33969/health' \
