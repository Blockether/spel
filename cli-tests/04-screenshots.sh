...
OPEN_SHOT_PATH="$TEST_TMP_DIR/test-cli-open-shot.png"
...
REV_SHOT_PATH="$TEST_TMP_DIR/test-cli-open-shot-rev.png"
...
GOTO_SHOT_PATH="$TEST_TMP_DIR/test-cli-goto-shot.png"
...
BARE_SHOT_PATH="$TEST_TMP_DIR/test-cli-bare-shot.png"
