## GET http://localhost:39995/health?i=307 → 200 OK

### Timing
Request started: 2026-09-20T15:22:21.115Z
...
host: localhost:39995
referer: http://localhost:39995/health
...
date: Sun, 20 Sep 2026 15:22:21 GMT
```
...
### cURL
```bash
curl 'http://localhost:39995/health?i=307' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:39995' \
  -H 'referer: http://localhost:39995/health' \
