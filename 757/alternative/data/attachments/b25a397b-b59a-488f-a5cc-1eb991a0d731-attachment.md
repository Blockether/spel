## GET http://localhost:44359/health?i=1006 → 200 OK

### Timing
Request started: 2026-09-20T15:22:53.178Z
...
host: localhost:44359
referer: http://localhost:44359/health
...
date: Sun, 20 Sep 2026 15:22:54 GMT
```
...
### cURL
```bash
curl 'http://localhost:44359/health?i=1006' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:44359' \
  -H 'referer: http://localhost:44359/health' \
