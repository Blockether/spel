## GET http://localhost:33825/set-cookie?name=session&value=abc123 → 404 Not Found

### Timing
Request started: 2026-09-11T14:59:14.317Z
...
date: Fri, 11 Sep 2026 14:59:14 GMT
```
...
### cURL
```bash
curl 'http://localhost:33825/set-cookie?name=session&value=abc123' \
  -H 'accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:33825' \
