## GET http://localhost:44367/health?i=1188 → 200 OK

### Timing
Request started: 2026-09-11T15:02:11.430Z
...
referer: http://localhost:44367/health
...
date: Fri, 11 Sep 2026 15:02:12 GMT
```
...
### cURL
```bash
curl 'http://localhost:44367/health?i=1188' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:44367' \
  -H 'referer: http://localhost:44367/health' \
