## POST http://127.0.0.1:42545/spel/hello → 200 OK

### Timing
Request started: 2026-08-20T10:17:02.339Z
...
host: 127.0.0.1:42545
origin: http://127.0.0.1:42545
referer: http://127.0.0.1:42545/
...
content-length: 11
content-type: application/json
date: Thu, 20 Aug 2026 10:17:02 GMT
```
...
### cURL
```bash
curl 'http://127.0.0.1:42545/spel/hello' \
  -X POST \
  -H 'accept: */*' \
  ...
  -H 'host: 127.0.0.1:42545' \
  -H 'origin: http://127.0.0.1:42545' \
  -H 'referer: http://127.0.0.1:42545/' \
