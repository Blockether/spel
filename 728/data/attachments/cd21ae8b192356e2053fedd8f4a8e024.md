## POST http://127.0.0.1:42545/spel/result → 200 OK

### Timing
Request started: 2026-08-20T10:17:02.449Z
...
```json
{
  ...
  "id": "0ef79ecc-f3bc-44e8-8484-4f1d190790fc"
}
```
...
### cURL
```bash
curl 'http://127.0.0.1:42545/spel/result' \
  -X POST \
  -H 'accept: */*' \
