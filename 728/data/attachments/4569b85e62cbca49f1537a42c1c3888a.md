## POST http://127.0.0.1:44245/spel/hello?t=s3cr3t → 200 OK

### Timing
Request started: 2026-08-20T10:17:03.141Z
...
### cURL
```bash
curl 'http://127.0.0.1:44245/spel/hello?t=s3cr3t' \
  -X POST \
  -H 'accept: */*' \
