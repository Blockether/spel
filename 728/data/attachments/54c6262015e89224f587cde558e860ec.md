## GET http://localhost:34385/health → 200 OK

### Timing
Request started: 2026-08-20T10:17:28.980Z
...
host: localhost:34385
referer: http://localhost:34385/
...
date: Thu, 20 Aug 2026 10:17:28 GMT
```
...
### cURL
```bash
curl 'http://localhost:34385/health' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:34385' \
  -H 'referer: http://localhost:34385/' \
