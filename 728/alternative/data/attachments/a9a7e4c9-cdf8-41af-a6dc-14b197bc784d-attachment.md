## POST http://127.0.0.1:44557/spel/result → 200 OK

### Timing
Request started: 2026-08-20T10:17:01.469Z
...
host: 127.0.0.1:44557
origin: http://127.0.0.1:44557
referer: http://127.0.0.1:44557/
...
```json
{
  ...
  "ok": true,
  "value": "ok",
  "id": "3379ada2-44ec-4fc3-aaa6-2f606a48c45b"
}
```
...
### cURL
```bash
curl 'http://127.0.0.1:44557/spel/result' \
  -X POST \
  -H 'accept: */*' \
  ...
  -H 'host: 127.0.0.1:44557' \
  -H 'origin: http://127.0.0.1:44557' \
  -H 'referer: http://127.0.0.1:44557/' \
