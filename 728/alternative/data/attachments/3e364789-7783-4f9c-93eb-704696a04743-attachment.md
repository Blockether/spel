## GET http://localhost:43449/health → 200 OK

### Timing
Request started: 2026-08-20T10:17:27.441Z
...
host: localhost:43449
referer: http://localhost:43449/
...
date: Thu, 20 Aug 2026 10:17:27 GMT
```
...
### cURL
```bash
curl 'http://localhost:43449/health' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:43449' \
  -H 'referer: http://localhost:43449/' \
