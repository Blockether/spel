## POST http://127.0.0.1:35343/spel/hello?t=prf → 200 OK

### Timing
Request started: 2026-08-20T10:17:04.746Z
...
origin: http://127.0.0.1:35343
referer: http://127.0.0.1:35343/
...
### cURL
```bash
curl 'http://127.0.0.1:35343/spel/hello?t=prf' \
  -X POST \
  -H 'accept: */*' \
  ...
  -H 'origin: http://127.0.0.1:35343' \
  -H 'referer: http://127.0.0.1:35343/' \
