...
The Referee also generates `bugfind-reports/qa-report.html` — a human-readable HTML report using the `refs/qa-report.html` template with Blockether design system styling.

### Step 7 (Optional): Video Recording

If the user requested video recording or a deep audit:
...
- HTML report generated by Referee
- Total: 3-5 agents
...
- HTML report + video + SRT transcript
- Total: 5-6 agents
...
- If @spel-bug-referee fails → present Hunter + Skeptic data without final verdict or HTML report
