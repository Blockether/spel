---
description: "Generates Clojure E2E tests from test plans using spel and spel.allure. Use when user says 'generate tests from this plan', 'write the test code', or 'implement the test spec'. Do NOT use for planning tests or fixing failures."
mode: subagent
color: "#3B82F6"
tools:
  write: true
