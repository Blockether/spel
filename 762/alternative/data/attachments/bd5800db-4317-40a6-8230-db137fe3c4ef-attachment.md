## GET http://localhost:41585/health?i=1048 → 200 OK

### Timing
Request started: 2026-09-24T22:48:41.414Z
...
host: localhost:41585
referer: http://localhost:41585/health
...
date: Thu, 24 Sep 2026 22:48:42 GMT
```
...
### cURL
```bash
curl 'http://localhost:41585/health?i=1048' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:41585' \
  -H 'referer: http://localhost:41585/health' \
