## GET http://localhost:38423/health?i=275 → 200 OK

### Timing
Request started: 2026-09-24T22:48:11.644Z
...
host: localhost:38423
referer: http://localhost:38423/health
...
date: Thu, 24 Sep 2026 22:48:11 GMT
```
...
### cURL
```bash
curl 'http://localhost:38423/health?i=275' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:38423' \
  -H 'referer: http://localhost:38423/health' \
