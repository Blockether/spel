## GET http://localhost:36397/health?i=245 → 200 OK

### Timing
Request started: 2026-09-14T20:39:08.489Z
...
host: localhost:36397
referer: http://localhost:36397/health
...
date: Mon, 14 Sep 2026 20:39:08 GMT
```
...
### cURL
```bash
curl 'http://localhost:36397/health?i=245' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:36397' \
  -H 'referer: http://localhost:36397/health' \
