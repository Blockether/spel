## GET http://localhost:46593/health?i=1159 → 200 OK

### Timing
Request started: 2026-09-14T20:39:39.786Z
...
referer: http://localhost:46593/health
...
date: Mon, 14 Sep 2026 20:39:40 GMT
```
...
### cURL
```bash
curl 'http://localhost:46593/health?i=1159' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:46593' \
  -H 'referer: http://localhost:46593/health' \
