## GET http://localhost:39949/health?i=1114 → 200 OK

### Timing
Request started: 2026-09-14T21:34:50.889Z
...
host: localhost:39949
referer: http://localhost:39949/health
...
date: Mon, 14 Sep 2026 21:34:52 GMT
```
...
### cURL
```bash
curl 'http://localhost:39949/health?i=1114' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:39949' \
  -H 'referer: http://localhost:39949/health' \
