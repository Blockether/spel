## GET http://localhost:35247/health?i=284 → 200 OK

### Timing
Request started: 2026-09-14T21:34:19.907Z
...
host: localhost:35247
referer: http://localhost:35247/health
...
date: Mon, 14 Sep 2026 21:34:20 GMT
```
...
### cURL
```bash
curl 'http://localhost:35247/health?i=284' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:35247' \
  -H 'referer: http://localhost:35247/health' \
