## GET http://localhost:34077/health?i=255 → 200 OK

### Timing
Request started: 2026-09-23T10:00:22.368Z
...
host: localhost:34077
referer: http://localhost:34077/health
...
date: Wed, 23 Sep 2026 10:00:22 GMT
```
...
### cURL
```bash
curl 'http://localhost:34077/health?i=255' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:34077' \
  -H 'referer: http://localhost:34077/health' \
