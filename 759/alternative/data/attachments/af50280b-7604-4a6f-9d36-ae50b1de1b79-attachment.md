## GET http://localhost:41025/health?i=1197 → 200 OK

### Timing
Request started: 2026-09-23T10:00:54.291Z
...
host: localhost:41025
referer: http://localhost:41025/health
...
date: Wed, 23 Sep 2026 10:00:55 GMT
```
...
### cURL
```bash
curl 'http://localhost:41025/health?i=1197' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:41025' \
  -H 'referer: http://localhost:41025/health' \
