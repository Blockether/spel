## GET http://localhost:46087/health?i=1061 → 200 OK

### Timing
Request started: 2026-09-11T05:56:05.831Z
...
referer: http://localhost:46087/health
...
date: Fri, 11 Sep 2026 05:56:06 GMT
```
...
### cURL
```bash
curl 'http://localhost:46087/health?i=1061' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:46087' \
  -H 'referer: http://localhost:46087/health' \
