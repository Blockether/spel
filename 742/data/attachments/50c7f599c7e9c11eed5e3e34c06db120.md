## GET http://localhost:34529/health?i=310 → 200 OK

### Timing
Request started: 2026-09-11T05:55:33.282Z
...
host: localhost:34529
referer: http://localhost:34529/health
...
date: Fri, 11 Sep 2026 05:55:33 GMT
```
...
### cURL
```bash
curl 'http://localhost:34529/health?i=310' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:34529' \
  -H 'referer: http://localhost:34529/health' \
