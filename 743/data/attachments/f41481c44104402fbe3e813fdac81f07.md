## GET http://localhost:42565/health?i=1160 → 200 OK

### Timing
Request started: 2026-09-11T08:08:24.913Z
...
host: localhost:42565
referer: http://localhost:42565/health
...
date: Fri, 11 Sep 2026 08:08:26 GMT
```
...
### cURL
```bash
curl 'http://localhost:42565/health?i=1160' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:42565' \
  -H 'referer: http://localhost:42565/health' \
