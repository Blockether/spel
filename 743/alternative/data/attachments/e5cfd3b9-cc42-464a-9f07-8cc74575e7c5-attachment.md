## GET http://localhost:41841/health?i=133 → 200 OK

### Timing
Request started: 2026-09-11T08:07:52.427Z
...
host: localhost:41841
referer: http://localhost:41841/health
...
date: Fri, 11 Sep 2026 08:07:52 GMT
```
...
### cURL
```bash
curl 'http://localhost:41841/health?i=133' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:41841' \
  -H 'referer: http://localhost:41841/health' \
