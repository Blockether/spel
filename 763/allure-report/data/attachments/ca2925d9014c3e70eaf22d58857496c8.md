## GET http://localhost:38855/health?i=268 → 200 OK

### Timing
Request started: 2026-09-24T23:53:38.492Z
...
host: localhost:38855
referer: http://localhost:38855/health
...
date: Thu, 24 Sep 2026 23:53:38 GMT
```
...
### cURL
```bash
curl 'http://localhost:38855/health?i=268' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:38855' \
  -H 'referer: http://localhost:38855/health' \
