## GET http://localhost:46763/health?i=1008 → 200 OK

### Timing
Request started: 2026-09-24T23:54:09.571Z
...
host: localhost:46763
referer: http://localhost:46763/health
...
date: Thu, 24 Sep 2026 23:54:10 GMT
```
...
### cURL
```bash
curl 'http://localhost:46763/health?i=1008' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:46763' \
  -H 'referer: http://localhost:46763/health' \
