## GET http://localhost:40047/set-cookie?name=session&value=abc123 → 404 Not Found

### Timing
Request started: 2026-09-24T23:05:27.547Z
...
date: Thu, 24 Sep 2026 23:05:27 GMT
```
...
### cURL
```bash
curl 'http://localhost:40047/set-cookie?name=session&value=abc123' \
  -H 'accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:40047' \
