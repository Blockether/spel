## GET http://localhost:39475/health?i=1086 → 200 OK

### Timing
Request started: 2026-09-24T23:07:35.076Z
...
host: localhost:39475
referer: http://localhost:39475/health
...
date: Thu, 24 Sep 2026 23:07:35 GMT
```
...
### cURL
```bash
curl 'http://localhost:39475/health?i=1086' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:39475' \
  -H 'referer: http://localhost:39475/health' \
