## GET http://localhost:38339/health?i=393 → 200 OK

### Timing
Request started: 2026-09-24T23:07:15.769Z
...
host: localhost:38339
referer: http://localhost:38339/health
...
date: Thu, 24 Sep 2026 23:07:16 GMT
```
...
### cURL
```bash
curl 'http://localhost:38339/health?i=393' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:38339' \
  -H 'referer: http://localhost:38339/health' \
