---
name: spel-test-generator
description: "Generates Clojure E2E tests from test plans using spel"
...
- Thoroughly explore all interactive elements, forms, navigation paths, and functionality
   ...
   After exploring, note exact selectors, text content, and expected values.
