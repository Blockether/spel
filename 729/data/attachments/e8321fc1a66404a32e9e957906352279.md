## GET http://localhost:44281/set-cookie?name=session&value=abc123 → 404 Not Found

### Timing
Request started: 2026-08-20T11:02:59.812Z
...
date: Thu, 20 Aug 2026 11:02:59 GMT
```
...
### cURL
```bash
curl 'http://localhost:44281/set-cookie?name=session&value=abc123' \
  -H 'accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:44281' \
