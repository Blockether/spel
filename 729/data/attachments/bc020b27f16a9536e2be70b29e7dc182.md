## POST http://127.0.0.1:44979/spel/hello → 200 OK

### Timing
Request started: 2026-08-20T11:03:38.171Z
...
host: 127.0.0.1:44979
origin: http://127.0.0.1:44979
referer: http://127.0.0.1:44979/
...
content-length: 11
content-type: application/json
date: Thu, 20 Aug 2026 11:03:38 GMT
```
...
### cURL
```bash
curl 'http://127.0.0.1:44979/spel/hello' \
  -X POST \
  -H 'accept: */*' \
  ...
  -H 'host: 127.0.0.1:44979' \
  -H 'origin: http://127.0.0.1:44979' \
  -H 'referer: http://127.0.0.1:44979/' \
