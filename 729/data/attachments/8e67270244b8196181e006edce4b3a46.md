## POST http://127.0.0.1:34889/spel/hello?t=rld → 200 OK

### Timing
Request started: 2026-08-20T11:03:41.550Z
...
host: 127.0.0.1:34889
origin: http://127.0.0.1:34889
referer: http://127.0.0.1:34889/
...
content-length: 11
content-type: application/json
date: Thu, 20 Aug 2026 11:03:41 GMT
```
...
### cURL
```bash
curl 'http://127.0.0.1:34889/spel/hello?t=rld' \
  -X POST \
  -H 'accept: */*' \
  ...
  -H 'host: 127.0.0.1:34889' \
  -H 'origin: http://127.0.0.1:34889' \
  -H 'referer: http://127.0.0.1:34889/' \
