## GET http://localhost:36907/health → 200 OK

### Timing
Request started: 2026-08-20T11:04:03.745Z
...
host: localhost:36907
referer: http://localhost:36907/
...
date: Thu, 20 Aug 2026 11:04:03 GMT
```
...
### cURL
```bash
curl 'http://localhost:36907/health' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:36907' \
  -H 'referer: http://localhost:36907/' \
