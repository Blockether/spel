## GET http://localhost:44857/nope-404 → 404 Not Found

### Timing
Request started: 2026-08-20T11:03:55.907Z
...
host: localhost:44857
referer: http://localhost:44857/
...
date: Thu, 20 Aug 2026 11:03:55 GMT
```
...
### cURL
```bash
curl 'http://localhost:44857/nope-404' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:44857' \
  -H 'referer: http://localhost:44857/' \
