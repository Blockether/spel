## GET http://localhost:35581/health → 200 OK

### Timing
Request started: 2026-08-20T11:04:05.280Z
...
### cURL
```bash
curl 'http://localhost:35581/health' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:35581' \
  -H 'referer: http://localhost:35581/' \
