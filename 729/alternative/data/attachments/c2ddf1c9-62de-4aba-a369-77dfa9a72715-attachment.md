## POST http://127.0.0.1:40661/spel/result?t=s3cr3t → 200 OK

### Timing
Request started: 2026-08-20T11:03:39.878Z
...
```json
{
  ...
  "ok": true,
  "value": "pong",
  "id": "c3a16714-2769-4655-9c54-9269a4fdcb3e"
}
```
...
### cURL
```bash
curl 'http://127.0.0.1:40661/spel/result?t=s3cr3t' \
  -X POST \
  -H 'accept: */*' \
