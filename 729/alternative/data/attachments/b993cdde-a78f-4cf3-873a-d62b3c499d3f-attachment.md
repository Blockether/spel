## POST http://127.0.0.1:44979/spel/result → 200 OK

### Timing
Request started: 2026-08-20T11:03:38.245Z
...
```json
{
  ...
  "id": "a4bbd462-7bec-4906-8333-48aabe91aa9b"
}
```
...
### cURL
```bash
curl 'http://127.0.0.1:44979/spel/result' \
  -X POST \
  -H 'accept: */*' \
