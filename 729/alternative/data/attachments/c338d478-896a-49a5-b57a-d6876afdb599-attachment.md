## POST http://127.0.0.1:41953/spel/hello?t=nosw → 200 OK

### Timing
Request started: 2026-08-20T11:03:42.570Z
...
content-length: 11
content-type: application/json
date: Thu, 20 Aug 2026 11:03:42 GMT
```
...
### cURL
```bash
curl 'http://127.0.0.1:41953/spel/hello?t=nosw' \
  -X POST \
  -H 'accept: */*' \
