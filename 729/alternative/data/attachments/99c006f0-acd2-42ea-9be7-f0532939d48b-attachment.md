## POST http://127.0.0.1:42753/spel/hello?t=tkn → 200 OK

### Timing
Request started: 2026-08-20T11:03:40.576Z
...
### cURL
```bash
curl 'http://127.0.0.1:42753/spel/hello?t=tkn' \
  -X POST \
  -H 'accept: */*' \
