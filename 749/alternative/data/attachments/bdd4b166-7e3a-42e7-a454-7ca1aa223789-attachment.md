## GET http://localhost:44897/health?i=315 → 200 OK

### Timing
Request started: 2026-09-11T19:41:22.908Z
...
referer: http://localhost:44897/health
...
date: Fri, 11 Sep 2026 19:41:23 GMT
```
...
### cURL
```bash
curl 'http://localhost:44897/health?i=315' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:44897' \
  -H 'referer: http://localhost:44897/health' \
