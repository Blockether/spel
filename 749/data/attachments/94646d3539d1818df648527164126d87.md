## GET http://localhost:38099/health?i=1107 → 200 OK

### Timing
Request started: 2026-09-11T19:41:56.343Z
...
host: localhost:38099
referer: http://localhost:38099/health
...
date: Fri, 11 Sep 2026 19:41:57 GMT
```
...
### cURL
```bash
curl 'http://localhost:38099/health?i=1107' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:38099' \
  -H 'referer: http://localhost:38099/health' \
