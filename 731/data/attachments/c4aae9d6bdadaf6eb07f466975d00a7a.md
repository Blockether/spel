## POST http://127.0.0.1:34675/spel/result → 200 OK

### Timing
Request started: 2026-08-21T02:17:09.350Z
...
```json
{
  ...
  "ok": true,
  "value": "pong",
  "id": "125a3e08-316c-4b51-971a-17ffaa447723"
}
```
...
### cURL
```bash
curl 'http://127.0.0.1:34675/spel/result' \
  -X POST \
  -H 'accept: */*' \
