## GET http://127.0.0.1:33263/spel/clients?t=dlg → 200 OK

### Timing
Request started: 2026-08-21T02:17:12.243Z
...
```json
{
  "clients": [
    {
      "connected-at": 1787278632104,
      "transport": "sse",
      "url": "http:\/\/127.0.0.1:33263\/",
      "title": "spel bridge",
      "tab-id": "tab-mt2bjulg-9t40h6",
      "user-agent": "Mozilla\/5.0 (X11; Linux x86_64) AppleWebKit\/537.36 (KHTML, like Gecko) HeadlessChrome\/149.0.7827.55 Safari\/537.36",
      "id": "0e60b203-ffc6-4f8a-9155-e9655ce9b080"
    }
  ]
}
```
...
### cURL
```bash
curl 'http://127.0.0.1:33263/spel/clients?t=dlg' \
  -H 'accept: */*' \
