## GET http://localhost:45831/health?i=1136 → 200 OK

### Timing
Request started: 2026-08-21T02:19:58.123Z
...
host: localhost:45831
referer: http://localhost:45831/health
...
date: Fri, 21 Aug 2026 02:19:59 GMT
```
...
### cURL
```bash
curl 'http://localhost:45831/health?i=1136' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:45831' \
  -H 'referer: http://localhost:45831/health' \
