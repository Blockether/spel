## GET http://localhost:36291/health → 200 OK

### Timing
Request started: 2026-08-21T02:17:34.082Z
...
host: localhost:36291
referer: http://localhost:36291/
...
date: Fri, 21 Aug 2026 02:17:34 GMT
```
...
### cURL
```bash
curl 'http://localhost:36291/health' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:36291' \
  -H 'referer: http://localhost:36291/' \
