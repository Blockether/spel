## POST http://127.0.0.1:32837/spel/result?t=s3cr3t → 200 OK

### Timing
Request started: 2026-08-21T02:17:10.164Z
...
origin: http://127.0.0.1:32837
referer: http://127.0.0.1:32837/
...
```json
{
  ...
  "ok": true,
  "value": "pong",
  "id": "61f782bb-0f4a-4c3e-8246-28e181f75d8e"
}
```
...
### cURL
```bash
curl 'http://127.0.0.1:32837/spel/result?t=s3cr3t' \
  -X POST \
  -H 'accept: */*' \
  ...
  -H 'host: 127.0.0.1:32837' \
  -H 'origin: http://127.0.0.1:32837' \
  -H 'referer: http://127.0.0.1:32837/' \
