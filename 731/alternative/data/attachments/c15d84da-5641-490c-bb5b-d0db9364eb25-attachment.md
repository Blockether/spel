## POST http://127.0.0.1:34675/spel/hello → 200 OK

### Timing
Request started: 2026-08-21T02:17:09.310Z
...
host: 127.0.0.1:34675
origin: http://127.0.0.1:34675
referer: http://127.0.0.1:34675/
...
content-length: 11
content-type: application/json
date: Fri, 21 Aug 2026 02:17:09 GMT
```
...
### cURL
```bash
curl 'http://127.0.0.1:34675/spel/hello' \
  -X POST \
  -H 'accept: */*' \
  ...
  -H 'host: 127.0.0.1:34675' \
  -H 'origin: http://127.0.0.1:34675' \
  -H 'referer: http://127.0.0.1:34675/' \
