## POST http://127.0.0.1:32837/spel/hello?t=s3cr3t → 200 OK

### Timing
Request started: 2026-08-21T02:17:10.136Z
...
### cURL
```bash
curl 'http://127.0.0.1:32837/spel/hello?t=s3cr3t' \
  -X POST \
  -H 'accept: */*' \
