## POST http://127.0.0.1:44057/spel/hello?t=rld → 200 OK

### Timing
Request started: 2026-08-21T02:17:11.879Z
...
host: 127.0.0.1:44057
origin: http://127.0.0.1:44057
referer: http://127.0.0.1:44057/
...
content-length: 11
content-type: application/json
date: Fri, 21 Aug 2026 02:17:11 GMT
```
...
### cURL
```bash
curl 'http://127.0.0.1:44057/spel/hello?t=rld' \
  -X POST \
  -H 'accept: */*' \
  ...
  -H 'host: 127.0.0.1:44057' \
  -H 'origin: http://127.0.0.1:44057' \
  -H 'referer: http://127.0.0.1:44057/' \
