## GET http://localhost:45997/health → 200 OK

### Timing
Request started: 2026-08-21T02:17:35.592Z
...
host: localhost:45997
referer: http://localhost:45997/
...
date: Fri, 21 Aug 2026 02:17:35 GMT
```
...
### cURL
```bash
curl 'http://localhost:45997/health' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:45997' \
  -H 'referer: http://localhost:45997/' \
