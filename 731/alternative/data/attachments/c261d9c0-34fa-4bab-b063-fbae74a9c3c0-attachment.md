## GET http://localhost:39623/nope-404 → 404 Not Found

### Timing
Request started: 2026-08-21T02:17:26.163Z
...
host: localhost:39623
referer: http://localhost:39623/
...
date: Fri, 21 Aug 2026 02:17:26 GMT
```
...
### cURL
```bash
curl 'http://localhost:39623/nope-404' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:39623' \
  -H 'referer: http://localhost:39623/' \
