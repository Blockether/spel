## POST http://127.0.0.1:33263/spel/hello?t=dlg → 200 OK

### Timing
Request started: 2026-08-21T02:17:12.106Z
...
origin: http://127.0.0.1:33263
referer: http://127.0.0.1:33263/
...
content-length: 11
content-type: application/json
date: Fri, 21 Aug 2026 02:17:12 GMT
```
...
### cURL
```bash
curl 'http://127.0.0.1:33263/spel/hello?t=dlg' \
  -X POST \
  -H 'accept: */*' \
  ...
  -H 'host: 127.0.0.1:33263' \
  -H 'origin: http://127.0.0.1:33263' \
  -H 'referer: http://127.0.0.1:33263/' \
