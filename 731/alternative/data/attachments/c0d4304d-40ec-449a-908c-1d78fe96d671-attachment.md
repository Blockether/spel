## POST http://127.0.0.1:38435/spel/result → 200 OK

### Timing
Request started: 2026-08-21T02:17:08.415Z
...
```json
{
  ...
  "ok": true,
  "value": "pong",
  "id": "facca549-fc87-4d71-b1ed-e903e5330bd2"
}
```
...
### cURL
```bash
curl 'http://127.0.0.1:38435/spel/result' \
  -X POST \
  -H 'accept: */*' \
