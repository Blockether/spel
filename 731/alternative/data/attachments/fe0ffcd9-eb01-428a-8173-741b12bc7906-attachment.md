## GET http://localhost:41977/health?i=390 → 200 OK

### Timing
Request started: 2026-08-21T02:19:25.911Z
...
host: localhost:41977
referer: http://localhost:41977/health
...
date: Fri, 21 Aug 2026 02:19:26 GMT
```
...
### cURL
```bash
curl 'http://localhost:41977/health?i=390' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:41977' \
  -H 'referer: http://localhost:41977/health' \
