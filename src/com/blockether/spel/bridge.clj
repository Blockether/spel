...
(defn extension-popup-html
  ...
  (str "<!doctype html>\n<html><head><meta charset=\"utf-8\"><meta name=\"color-scheme\" content=\"light\"><title>spel bridge</title>\n"
    ...
    "button{margin-top:16px;width:100%;padding:10px 12px;border:0;border-radius:8px;background:linear-gradient(180deg,#ffd54a,#f5a623)!important;color:#4a3200!important;font-weight:700;font-size:13px;letter-spacing:.2px;cursor:pointer;box-shadow:0 2px 8px rgba(245,166,35,.35);transition:filter .15s,transform .05s,box-shadow .15s}button:hover{filter:brightness(1.04);box-shadow:0 3px 12px rgba(245,166,35,.45)}button:active{transform:translateY(1px)}"
    ".st{margin-top:12px;font-size:12px;color:#b06a00;min-height:16px}</style></head>\n"
