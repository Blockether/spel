...
(defn extension-popup-html
  ...
  (str "<!doctype html>\n<html><head><meta charset=\"utf-8\"><meta name=\"color-scheme\" content=\"light\"><title>spel bridge</title>\n"
    ...
    "button{margin-top:16px;width:100%;padding:10px 12px;border:0;border-radius:8px;background:#1f7a3d!important;color:#fff!important;font-weight:700;font-size:13px;letter-spacing:.2px;cursor:pointer;box-shadow:0 1px 3px rgba(0,0,0,.12);transition:background .15s,transform .05s}button:hover{background:#1a6a35}button:active{transform:translateY(1px)}"
