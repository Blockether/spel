...
- These are generated artifacts, gitignored, and regenerated by `make init-agents`
- ALWAYS edit source templates in `resources/com/blockether/spel/templates/` and regenerate
- Reference files live in `resources/.../templates/skills/spel/refs/` — edit those, not `.opencode/`
...
| Reference files (edit these) | `resources/.../templates/skills/spel/refs/*.md` |
| Generated skill (DO NOT EDIT) | `.opencode/skills/spel/SKILL.md` (gitignored, regenerated) |
