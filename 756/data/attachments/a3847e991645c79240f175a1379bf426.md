## GET http://localhost:45173/health?i=1012 → 200 OK

### Timing
Request started: 2026-09-20T13:30:53.624Z
...
host: localhost:45173
referer: http://localhost:45173/health
...
date: Sun, 20 Sep 2026 13:30:54 GMT
```
...
### cURL
```bash
curl 'http://localhost:45173/health?i=1012' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:45173' \
  -H 'referer: http://localhost:45173/health' \
