## GET http://localhost:45841/health?i=255 → 200 OK

### Timing
Request started: 2026-09-20T13:30:22.601Z
...
host: localhost:45841
referer: http://localhost:45841/health
...
date: Sun, 20 Sep 2026 13:30:22 GMT
```
...
### cURL
```bash
curl 'http://localhost:45841/health?i=255' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:45841' \
  -H 'referer: http://localhost:45841/health' \
