## POST http://127.0.0.1:41511/spel/hello?t=s3cr3t → 200 OK

### Timing
Request started: 2026-08-24T08:25:53.722Z
...
### cURL
```bash
curl 'http://127.0.0.1:41511/spel/hello?t=s3cr3t' \
  -X POST \
  -H 'accept: */*' \
