## GET http://127.0.0.1:40105/ → 200 OK

### Timing
Request started: 2026-08-24T08:25:56.290Z
...
<script>
  window.__spel.connect({ url: window.location.origin + "\/spel", token: "nosw" });
</script>
</body></html>
