## POST http://127.0.0.1:42559/spel/result → 200 OK

### Timing
Request started: 2026-08-24T08:25:52.212Z
...
```json
{
  ...
  "ok": true,
  "value": "ok",
  "id": "b1fe9da7-f1af-42ab-a2e7-4788bac13231"
}
```
...
### cURL
```bash
curl 'http://127.0.0.1:42559/spel/result' \
  -X POST \
  -H 'accept: */*' \
