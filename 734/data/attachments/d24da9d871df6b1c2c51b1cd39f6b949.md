## POST http://127.0.0.1:37943/spel/hello → 200 OK

### Timing
Request started: 2026-08-24T08:25:53.005Z
...
### cURL
```bash
curl 'http://127.0.0.1:37943/spel/hello' \
  -X POST \
  -H 'accept: */*' \
