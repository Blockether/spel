## GET http://localhost:35095/health → 200 OK

### Timing
Request started: 2026-08-24T08:26:08.199Z
...
host: localhost:35095
referer: http://localhost:35095/
...
date: Mon, 24 Aug 2026 08:26:08 GMT
```
...
### cURL
```bash
curl 'http://localhost:35095/health' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:35095' \
  -H 'referer: http://localhost:35095/' \
