## POST http://127.0.0.1:45401/spel/hello → 200 OK

### Timing
Request started: 2026-08-24T08:25:52.391Z
...
origin: http://127.0.0.1:45401
referer: http://127.0.0.1:45401/
...
### cURL
```bash
curl 'http://127.0.0.1:45401/spel/hello' \
  -X POST \
  -H 'accept: */*' \
  ...
  -H 'origin: http://127.0.0.1:45401' \
  -H 'referer: http://127.0.0.1:45401/' \
