## GET http://localhost:42027/health?i=249 → 200 OK

### Timing
Request started: 2026-08-24T08:28:02.285Z
...
host: localhost:42027
referer: http://localhost:42027/health
...
date: Mon, 24 Aug 2026 08:28:02 GMT
```
...
### cURL
```bash
curl 'http://localhost:42027/health?i=249' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:42027' \
  -H 'referer: http://localhost:42027/health' \
