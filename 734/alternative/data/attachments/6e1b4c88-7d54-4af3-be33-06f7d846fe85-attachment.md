## POST http://127.0.0.1:39187/spel/hello?t=tkn → 200 OK

### Timing
Request started: 2026-08-24T08:25:54.439Z
...
### cURL
```bash
curl 'http://127.0.0.1:39187/spel/hello?t=tkn' \
  -X POST \
  -H 'accept: */*' \
