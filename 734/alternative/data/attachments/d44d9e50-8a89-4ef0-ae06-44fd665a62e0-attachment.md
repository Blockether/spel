## POST http://127.0.0.1:42559/spel/hello → 200 OK

### Timing
Request started: 2026-08-24T08:25:52.160Z
...
host: 127.0.0.1:42559
origin: http://127.0.0.1:42559
referer: http://127.0.0.1:42559/
...
content-length: 11
content-type: application/json
date: Mon, 24 Aug 2026 08:25:52 GMT
```
...
### cURL
```bash
curl 'http://127.0.0.1:42559/spel/hello' \
  -X POST \
  -H 'accept: */*' \
  ...
  -H 'host: 127.0.0.1:42559' \
  -H 'origin: http://127.0.0.1:42559' \
  -H 'referer: http://127.0.0.1:42559/' \
