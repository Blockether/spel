## POST http://127.0.0.1:33985/spel/hello?t=dlg → 200 OK

### Timing
Request started: 2026-08-24T08:25:55.630Z
...
### cURL
```bash
curl 'http://127.0.0.1:33985/spel/hello?t=dlg' \
  -X POST \
  -H 'accept: */*' \
