## POST http://127.0.0.1:41081/spel/hello?t=prf → 200 OK

### Timing
Request started: 2026-08-24T08:25:55.275Z
...
origin: http://127.0.0.1:41081
referer: http://127.0.0.1:41081/
...
### cURL
```bash
curl 'http://127.0.0.1:41081/spel/hello?t=prf' \
  -X POST \
  -H 'accept: */*' \
  ...
  -H 'origin: http://127.0.0.1:41081' \
  -H 'referer: http://127.0.0.1:41081/' \
