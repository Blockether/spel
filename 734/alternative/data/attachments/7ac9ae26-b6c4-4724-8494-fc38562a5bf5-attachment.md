## GET http://localhost:36633/health → 200 OK

### Timing
Request started: 2026-08-24T08:26:16.975Z
...
### cURL
```bash
curl 'http://localhost:36633/health' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:36633' \
  -H 'referer: http://localhost:36633/' \
