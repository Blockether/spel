## GET http://localhost:44895/health?i=137 → 200 OK

### Timing
Request started: 2026-09-15T10:33:34.539Z
...
host: localhost:44895
referer: http://localhost:44895/health
...
date: Tue, 15 Sep 2026 10:33:34 GMT
```
...
### cURL
```bash
curl 'http://localhost:44895/health?i=137' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:44895' \
  -H 'referer: http://localhost:44895/health' \
