## GET http://localhost:46511/health?i=200 → 200 OK

### Timing
Request started: 2026-09-15T11:19:04.870Z
...
host: localhost:46511
referer: http://localhost:46511/health
...
date: Tue, 15 Sep 2026 11:19:04 GMT
```
...
### cURL
```bash
curl 'http://localhost:46511/health?i=200' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:46511' \
  -H 'referer: http://localhost:46511/health' \
