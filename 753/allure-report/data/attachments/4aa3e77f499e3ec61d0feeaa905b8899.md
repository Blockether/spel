## GET http://localhost:43973/health?i=1072 → 200 OK

### Timing
Request started: 2026-09-15T11:19:25.995Z
...
referer: http://localhost:43973/health
...
date: Tue, 15 Sep 2026 11:19:26 GMT
```
...
### cURL
```bash
curl 'http://localhost:43973/health?i=1072' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:43973' \
  -H 'referer: http://localhost:43973/health' \
