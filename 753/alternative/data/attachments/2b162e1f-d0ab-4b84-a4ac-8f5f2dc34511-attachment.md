## GET http://localhost:45945/health?i=1104 → 200 OK

### Timing
Request started: 2026-09-15T10:34:05.813Z
...
host: localhost:45945
referer: http://localhost:45945/health
...
date: Tue, 15 Sep 2026 10:34:06 GMT
```
...
### cURL
```bash
curl 'http://localhost:45945/health?i=1104' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:45945' \
  -H 'referer: http://localhost:45945/health' \
