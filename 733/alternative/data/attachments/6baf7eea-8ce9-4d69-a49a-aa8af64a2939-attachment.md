## GET http://localhost:39107/health → 200 OK

### Timing
Request started: 2026-08-22T11:39:58.224Z
...
date: Sat, 22 Aug 2026 11:39:58 GMT
```
...
### cURL
```bash
curl 'http://localhost:39107/health' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:39107' \
  -H 'referer: http://localhost:39107/' \
