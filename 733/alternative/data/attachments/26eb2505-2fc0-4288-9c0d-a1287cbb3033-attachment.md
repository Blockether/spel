## POST http://127.0.0.1:44091/spel/hello?t=dlg → 200 OK

### Timing
Request started: 2026-08-22T11:39:34.574Z
...
### cURL
```bash
curl 'http://127.0.0.1:44091/spel/hello?t=dlg' \
  -X POST \
  -H 'accept: */*' \
