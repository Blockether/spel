## POST http://127.0.0.1:35803/spel/hello → 200 OK

### Timing
Request started: 2026-08-22T11:39:31.763Z
...
### cURL
```bash
curl 'http://127.0.0.1:35803/spel/hello' \
  -X POST \
  -H 'accept: */*' \
