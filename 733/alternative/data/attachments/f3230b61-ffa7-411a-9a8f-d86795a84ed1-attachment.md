## GET http://localhost:34229/health?i=1033 → 200 OK

### Timing
Request started: 2026-08-22T11:42:26.612Z
...
host: localhost:34229
referer: http://localhost:34229/health
...
date: Sat, 22 Aug 2026 11:42:27 GMT
```
...
### cURL
```bash
curl 'http://localhost:34229/health?i=1033' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:34229' \
  -H 'referer: http://localhost:34229/health' \
