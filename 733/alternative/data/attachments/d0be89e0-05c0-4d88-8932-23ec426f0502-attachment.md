## POST http://127.0.0.1:43249/spel/result?t=tkn → 200 OK

### Timing
Request started: 2026-08-22T11:39:33.464Z
...
```json
{
  ...
  "ok": true,
  "value": "pong",
  "id": "69dd5fe7-89c6-4641-8a95-6035f67754a1"
}
```
...
### cURL
```bash
curl 'http://127.0.0.1:43249/spel/result?t=tkn' \
  -X POST \
  -H 'accept: */*' \
