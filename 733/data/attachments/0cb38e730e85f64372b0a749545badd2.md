## POST http://127.0.0.1:44127/spel/hello?t=nosw → 200 OK

### Timing
Request started: 2026-08-22T11:39:35.396Z
...
host: 127.0.0.1:44127
origin: http://127.0.0.1:44127
referer: http://127.0.0.1:44127/
...
content-length: 11
content-type: application/json
date: Sat, 22 Aug 2026 11:39:35 GMT
```
...
### cURL
```bash
curl 'http://127.0.0.1:44127/spel/hello?t=nosw' \
  -X POST \
  -H 'accept: */*' \
  ...
  -H 'host: 127.0.0.1:44127' \
  -H 'origin: http://127.0.0.1:44127' \
  -H 'referer: http://127.0.0.1:44127/' \
