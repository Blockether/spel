## GET http://127.0.0.1:34383/ → 200 OK

### Timing
Request started: 2026-08-22T11:39:32.513Z
...
<script>
  window.__spel.connect({ url: window.location.origin + "\/spel", token: "s3cr3t" });
</script>
</body></html>
