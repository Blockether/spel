## POST http://127.0.0.1:46817/spel/hello → 200 OK

### Timing
Request started: 2026-08-22T11:39:30.848Z
...
### cURL
```bash
curl 'http://127.0.0.1:46817/spel/hello' \
  -X POST \
  -H 'accept: */*' \
