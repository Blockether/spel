## GET http://localhost:35491/nope-404 → 404 Not Found

### Timing
Request started: 2026-08-22T11:39:48.683Z
...
### cURL
```bash
curl 'http://localhost:35491/nope-404' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:35491' \
  -H 'referer: http://localhost:35491/' \
