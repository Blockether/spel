## POST http://127.0.0.1:34383/spel/hello?t=s3cr3t → 200 OK

### Timing
Request started: 2026-08-22T11:39:32.572Z
...
### cURL
```bash
curl 'http://127.0.0.1:34383/spel/hello?t=s3cr3t' \
  -X POST \
  -H 'accept: */*' \
