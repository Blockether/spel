## GET http://localhost:43589/health?i=184 → 200 OK

### Timing
Request started: 2026-09-11T04:23:46.824Z
...
host: localhost:43589
referer: http://localhost:43589/health
...
date: Fri, 11 Sep 2026 04:23:46 GMT
```
...
### cURL
```bash
curl 'http://localhost:43589/health?i=184' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:43589' \
  -H 'referer: http://localhost:43589/health' \
