## GET http://localhost:40009/health?i=1071 → 200 OK

### Timing
Request started: 2026-09-11T04:24:10.191Z
...
referer: http://localhost:40009/health
...
date: Fri, 11 Sep 2026 04:24:11 GMT
```
...
### cURL
```bash
curl 'http://localhost:40009/health?i=1071' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:40009' \
  -H 'referer: http://localhost:40009/health' \
