## GET http://localhost:33817/health?i=1152 → 200 OK

### Timing
Request started: 2026-09-11T11:41:24.769Z
...
host: localhost:33817
referer: http://localhost:33817/health
...
date: Fri, 11 Sep 2026 11:41:25 GMT
```
...
### cURL
```bash
curl 'http://localhost:33817/health?i=1152' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:33817' \
  -H 'referer: http://localhost:33817/health' \
