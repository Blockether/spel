## GET http://localhost:41949/health?i=130 → 200 OK

### Timing
Request started: 2026-09-11T11:40:53.355Z
...
host: localhost:41949
referer: http://localhost:41949/health
...
date: Fri, 11 Sep 2026 11:40:53 GMT
```
...
### cURL
```bash
curl 'http://localhost:41949/health?i=130' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:41949' \
  -H 'referer: http://localhost:41949/health' \
