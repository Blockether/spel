## GET http://localhost:42505/health?i=202 → 200 OK

### Timing
Request started: 2026-09-15T13:28:00.742Z
...
host: localhost:42505
referer: http://localhost:42505/health
...
date: Tue, 15 Sep 2026 13:28:00 GMT
```
...
### cURL
```bash
curl 'http://localhost:42505/health?i=202' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:42505' \
  -H 'referer: http://localhost:42505/health' \
