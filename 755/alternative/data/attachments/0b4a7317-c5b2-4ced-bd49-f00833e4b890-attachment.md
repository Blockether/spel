## GET http://localhost:44731/health?i=1172 → 200 OK

### Timing
Request started: 2026-09-15T13:28:28.259Z
...
host: localhost:44731
referer: http://localhost:44731/health
...
date: Tue, 15 Sep 2026 13:28:29 GMT
```
...
### cURL
```bash
curl 'http://localhost:44731/health?i=1172' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:44731' \
  -H 'referer: http://localhost:44731/health' \
