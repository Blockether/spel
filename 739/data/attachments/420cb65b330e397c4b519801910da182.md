## GET http://localhost:37387/health?i=298 → 200 OK

### Timing
Request started: 2026-09-11T02:44:46.978Z
...
host: localhost:37387
referer: http://localhost:37387/health
...
date: Fri, 11 Sep 2026 02:44:47 GMT
```
...
### cURL
```bash
curl 'http://localhost:37387/health?i=298' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:37387' \
  -H 'referer: http://localhost:37387/health' \
