## GET http://localhost:46851/health?i=1011 → 200 OK

### Timing
Request started: 2026-09-11T02:45:06.918Z
...
host: localhost:46851
referer: http://localhost:46851/health
...
date: Fri, 11 Sep 2026 02:45:07 GMT
```
...
### cURL
```bash
curl 'http://localhost:46851/health?i=1011' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:46851' \
  -H 'referer: http://localhost:46851/health' \
