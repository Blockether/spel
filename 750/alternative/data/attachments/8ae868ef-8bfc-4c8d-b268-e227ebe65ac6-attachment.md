## GET http://localhost:38027/health?i=1169 → 200 OK

### Timing
Request started: 2026-09-11T20:41:52.019Z
...
host: localhost:38027
referer: http://localhost:38027/health
...
date: Fri, 11 Sep 2026 20:41:53 GMT
```
...
### cURL
```bash
curl 'http://localhost:38027/health?i=1169' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:38027' \
  -H 'referer: http://localhost:38027/health' \
