## GET http://localhost:45617/health?i=326 → 200 OK

### Timing
Request started: 2026-09-11T20:41:19.091Z
...
referer: http://localhost:45617/health
...
date: Fri, 11 Sep 2026 20:41:19 GMT
```
...
### cURL
```bash
curl 'http://localhost:45617/health?i=326' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:45617' \
  -H 'referer: http://localhost:45617/health' \
