## GET http://localhost:46815/health?i=207 → 200 OK

### Timing
Request started: 2026-09-23T11:29:25.622Z
...
host: localhost:46815
referer: http://localhost:46815/health
...
date: Wed, 23 Sep 2026 11:29:25 GMT
```
...
### cURL
```bash
curl 'http://localhost:46815/health?i=207' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:46815' \
  -H 'referer: http://localhost:46815/health' \
