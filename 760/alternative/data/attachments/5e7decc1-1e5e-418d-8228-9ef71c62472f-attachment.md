## GET http://localhost:43413/health?i=1156 → 200 OK

### Timing
Request started: 2026-09-23T11:29:49.123Z
...
host: localhost:43413
referer: http://localhost:43413/health
...
date: Wed, 23 Sep 2026 11:29:50 GMT
```
...
### cURL
```bash
curl 'http://localhost:43413/health?i=1156' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:43413' \
  -H 'referer: http://localhost:43413/health' \
