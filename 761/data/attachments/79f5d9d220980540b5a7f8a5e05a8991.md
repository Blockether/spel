## GET http://localhost:42913/health?i=1075 → 200 OK

### Timing
Request started: 2026-09-23T12:29:13.553Z
...
host: localhost:42913
referer: http://localhost:42913/health
...
date: Wed, 23 Sep 2026 12:29:14 GMT
```
...
### cURL
```bash
curl 'http://localhost:42913/health?i=1075' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:42913' \
  -H 'referer: http://localhost:42913/health' \
