## GET http://localhost:41877/health?i=256 → 200 OK

### Timing
Request started: 2026-09-23T12:28:42.673Z
...
host: localhost:41877
referer: http://localhost:41877/health
...
date: Wed, 23 Sep 2026 12:28:42 GMT
```
...
### cURL
```bash
curl 'http://localhost:41877/health?i=256' \
  -H 'accept: */*' \
  -H 'accept-encoding: gzip, deflate, br, zstd' \
  -H 'connection: keep-alive' \
  -H 'host: localhost:41877' \
  -H 'referer: http://localhost:41877/health' \
